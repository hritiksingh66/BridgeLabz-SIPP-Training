...
class StudentLinkedList{
	...
	public void Search(int roll) {
		...
		if(head.roll == roll) {
			...
			System.out.println("Student Roll Number: " + head.roll + " Name: " + head.name + " Age: " + head.age + " Grade: " + head.grade);
		}
		while(temp.next != null && temp.next.roll != roll) {
			temp = temp.next;
		}
		if(temp.next == null) {
			...
			System.out.println("Search Result");
			System.out.println("Student Roll Number: " + temp.next.roll + " Name: " + temp.next.name + " Age: " + temp.next.age + " Grade: " + temp.next.grade);
		}
	}
	...
	void Display() {
		...
		while(curr != null) {
			System.out.println("Student Roll Number: " + curr.roll + " Name: " + curr.name + " Age: " + curr.age + " Grade: " + curr.grade);
			curr = curr.next;
		}
	}
}
