...
class LibraryLinkedList{
	...
	public void SearchT(String BookTitle) {
		...
		if(head.BookTitle.equals(BookTitle)) {
			System.out.println("Book Title: " + head.BookTitle + " | Author: " + head.Author + " | Genre: " + head.Genre + " | ID: " + head.BookID + " | Availability Status: " + head.AvailabilityStatus);
			return;
		}
		...
		if(temp.next == null) {
			...
			System.out.println("Book Title: " + temp.next.BookTitle + " | Author: " + temp.next.Author + " | Genre: " + temp.next.Genre + " | ID: " + temp.next.BookID + " | Availability Status: " + temp.next.AvailabilityStatus);
		}
	}
	...
	public void DisplayF() {
		...
		while(temp != null) {
			System.out.println("Book Title: " + temp.BookTitle + " | Author: " + temp.Author + " | Genre: " + temp.Genre + " | ID: " + temp.BookID + " | Availability Status: " + temp.AvailabilityStatus);
			temp = temp.next;
		}
	}
