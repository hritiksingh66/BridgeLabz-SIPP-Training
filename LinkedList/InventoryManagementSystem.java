...
class InventoryLinkedList{
	...
	public void SearchI(int ItemID) {
		...
		if(head.ItemID == ItemID) {
			System.out.println("Item ID: " + head.ItemID + " | Name: " + head.ItemName + " | Quantity: " + head.Quantity + " | Price: " + head.Price);
			return;
		}
		while(temp.next != null && temp.next.ItemID != ItemID) {
			temp = temp.next;
		...
		if(temp.next == null) {
			...
			System.out.println("Item ID: " + temp.next.ItemID + " | Name: " + temp.next.ItemName + " | Quantity: " + temp.next.Quantity + " | Price: " + temp.next.Price);
		}
	}
