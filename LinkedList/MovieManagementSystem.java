...
class MovieLinkedList{
	...
	public void SearchD(String Director) {
		...
		if(head.Director == Director) {
			System.out.println("Movie Title: " + head.MovieTitle + " Director: " + head.Director + " Release Year: " + head.ReleaseYear + " Rating: " + head.Rating);
		}
		...
		if(temp.next == null) {
			...
			System.out.println("Movie Title: " + temp.next.MovieTitle + " Director: " + temp.next.Director + " Release Year: " + temp.next.ReleaseYear + " Rating: " + temp.next.Rating);
		}
	}
	...
	public void DisplayF() {
		...
		MovieNode temp = head;
		while(temp != null) {
			System.out.println("Movie Title: " + temp.MovieTitle + " Director: " + temp.Director + " Release Year: " + temp.ReleaseYear + " Rating: " + temp.Rating);
			temp = temp.next;
		}
	}
